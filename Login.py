...
class Login_Reg:
    def __init__(self,window) -> None:
        ...
        #elf.window.state('zoomed')
        #self.window.geometry('1200x600')
        self.window.resizable(0, 0)
        window.geometry('1600x700')
        self.window.title('Login Dashboard - 1.0')
        ...
        design_frame1 = Listbox(LoginPage, bg='lightgrey', width=255, height=50, highlightthickness=0, borderwidth=0)
        design_frame1.place(x=0, y=0)

        design_frame2 = Listbox(LoginPage, bg='lightgrey', width=115, height=50, highlightthickness=0, borderwidth=0)
        design_frame2.place(x=676, y=0)

        design_frame3 = Listbox(LoginPage, bg='lightgrey', width=150, height=33, highlightthickness=0, borderwidth=0)
        design_frame3.place(x=5, y=106)

        design_frame4 = Listbox(LoginPage, bg='#f8f8f8', width=100, height=33, highlightthickness=0, borderwidth=0)
        design_frame4.place(x=776, y=106)
        ...
        # ========= Buttons ===============
        SignUp_button = Button(LoginPage, text='Sign up', font=("yu gothic ui bold", 12), bg='#f8f8f8', fg="black",
                            command=lambda: show_frame(RegistrationPage), borderwidth=0, activebackground='darkorange', cursor='hand2')
        ...
        # ======= top Login Button =========
        login_button = Button(LoginPage, text='Login', font=("yu gothic ui bold", 12), bg='#f8f8f8', fg="black",
                            borderwidth=0, activebackground='darkorange', cursor='hand2')
        login_button.place(x=845, y=175)

        login_line = Canvas(LoginPage, width=60, height=5, bg='black')
        login_line.place(x=840, y=203)

        # ==== LOGIN  down button ============
        loginBtn1 = Button(design_frame4, fg='black', text='Login', bg='darkorange', font=("yu gothic ui bold", 15),
                        cursor='hand2', activebackground='darkorange', command=lambda: login())
        ...
        side_image_label = Label(design_frame3, image=photo)
        ...
        def forgot_password():
            ...
            update_pass = Button(win, fg='black', text='Update Password', bg='orange', font=("yu gothic ui bold", 14),
                                cursor='hand2', activebackground='orange', command=lambda: change_password())
        ...
        design_frame5 = Listbox(RegistrationPage, bg='lightgrey', width=255, height=50, highlightthickness=0, borderwidth=0)
        design_frame5.place(x=0, y=0)

        design_frame6 = Listbox(RegistrationPage, bg='lightgrey', width=115, height=50, highlightthickness=0, borderwidth=0)
        design_frame6.place(x=676, y=0)

        design_frame7 = Listbox(RegistrationPage, bg='lightgrey', width=150, height=33, highlightthickness=0, borderwidth=0)
        design_frame7.place(x=5, y=106)

        design_frame8 = Listbox(RegistrationPage, bg='#f8f8f8', width=100, height=33, highlightthickness=0, borderwidth=0)
        design_frame8.place(x=776, y=106)
        ...
        # ========= Buttons ====================
        SignUp_button = Button(RegistrationPage, text='Sign up', font=("yu gothic ui bold", 12), bg='#f8f8f8', fg="black",
                            command=lambda: show_frame(LoginPage), borderwidth=0, activebackground='darkorange', cursor='hand2')
        SignUp_button.place(x=1100, y=175)

        SignUp_line = Canvas(RegistrationPage, width=60, height=5, bg='black')
        ...
        login_button = Button(RegistrationPage, text='Login', font=("yu gothic ui bold", 12), bg='#f8f8f8', fg="#89898b",
                            borderwidth=0, activebackground='darkorange', command=lambda: show_frame(LoginPage), cursor='hand2')
        login_button.place(x=845, y=175)

        # ==== SIGN UP down button ============
        signUp2 = Button(design_frame8, fg='black', text='Sign Up', bg='darkorange', font=("yu gothic ui bold", 15),
                        cursor='hand2', activebackground='darkorange', command=lambda: submit())
        ...
        side_image = Image.open('images\\vector.png')
        photo = ImageTk.PhotoImage(side_image)
        side_image_label = Label(design_frame7, image=photo)
        side_image_label.image = photo
        side_image_label.place(x=50, y=10)
